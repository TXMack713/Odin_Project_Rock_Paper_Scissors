...
function getUserChoice() {
  ...
  const rock = document.body.getElementsByClassName('rock');
  const paper = document.body.getElementsByClassName('paper');
  const scissors = document.body.getElementsByClassName('scissors');
  // entry = prompt(
